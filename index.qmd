...
Note: In Google Sites, support for custom domains is currently not available for managed accounts, like an @g.harvard.edu account. If you really want to use a custom domain (i.e. yourname.com), then you should either use GitHub Pages or use your personal account to make your Google Site.
